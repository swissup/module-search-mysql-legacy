...
use Swissup\SearchMysqlLegacy\SearchAdapter\Mysql\Aggregation\Builder as AggregationBuilder;
...
//        var_dump($request->getIndex());
//        var_dump(get_class_methods($request));
//        var_dump(get_class($this->mapper));
//        \Swissup\SearchMysqlLegacy\SearchAdapter\Mysql\Mapper::class;
////        var_dump(get_class_methods($request->getQuery()));
//        echo '</pre>';
//        die;
